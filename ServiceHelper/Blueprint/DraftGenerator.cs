...
namespace ServiceHelper.Blueprint
{
    public static class DraftGenerator
    {
        private static string _path = AppDomain.CurrentDomain.BaseDirectory;

        public static void GenerateDraft(string user, OrderAccounting orderAccounting)
        {
            Generator.GeneratedClass Draft = new Generator.GeneratedClass();

            Draft.text1.Text = "ФИО " + user;
            Draft.text3.Text = orderAccounting.Cost.ToString() + "(-)";
            Draft.text4.Text = "=" + orderAccounting.Cost.ToString();
            Draft.text6.Text = "=" + orderAccounting.Cost.ToString();
            Draft.text8.Text = orderAccounting.Cost.ToString();
            Draft.text9.Text = orderAccounting.Date;
            Draft.text10.Text = DateTime.Now.ToString("HH:MM");
            Draft.text12.Text = " " + user;
            Draft.text15.Text = DateTime.Now.Ticks.ToString();

            Draft.CreatePackage(_path + "draft.docx");
        }
    }
}
...
namespace ServiceHelper.Blueprint.Generator
{
    public class GeneratedClass
    {

        public Text text1 = new Text(); //Name
        public Text text3 = new Text(); //CK1 Cost
        public Text text4 = new Text(); // = Cost
        public Text text6 = new Text(); //Cost
        public Text text8 = new Text(); //Nal Cost
        public Text text9 = new Text(); //Date
        public Text text10 = new Text(); //Time
        public Text text12 = new Text(); //Name 
        public Text text15 = new Text(); //Draft
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "222";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00BE0798", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            Run run1 = new Run() { RsidRunProperties = "00561389" };
            ...
            //Text text1 = new Text();
            //text1.Text = "ФИО ___________________________________";
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00561389" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };

            ParagraphProperties paragraphProperties3 = new ParagraphProperties();

            ParagraphBorders paragraphBorders1 = new ParagraphBorders();
            BottomBorder bottomBorder1 = new BottomBorder() { Val = BorderValues.Wave, Color = "auto", Size = (UInt32Value)6U, Space = (UInt32Value)1U };
            ...
            Run run3 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run4 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run5 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run6 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run7 = new Run() { RsidRunProperties = "00561389" };
            ...
            run7.Append(tabChar5);

            Run run8 = new Run() { RsidRunProperties = "00561389" };
            ...
            run8.Append(tabChar6);

            Run run9 = new Run() { RsidRunProperties = "00561389" };
            ...
            run9.Append(tabChar7);

            Run run10 = new Run() { RsidRunProperties = "00561389" };
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };

            ParagraphProperties paragraphProperties4 = new ParagraphProperties();

            ParagraphBorders paragraphBorders2 = new ParagraphBorders();
            BottomBorder bottomBorder2 = new BottomBorder() { Val = BorderValues.Wave, Color = "auto", Size = (UInt32Value)6U, Space = (UInt32Value)1U };
            ...
            paragraphProperties4.Append(paragraphBorders2);
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            paragraphMarkRunProperties5.Append(languages1);
            ...
            Paragraph paragraph6 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            Run run11 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run12 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run13 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run14 = new Run() { RsidRunProperties = "00561389" };
            ...
            Run run15 = new Run() { RsidRunProperties = "00561389" };
            ...
            run15.Append(tabChar12);

            Run run16 = new Run() { RsidRunProperties = "00561389" };
            ...
            run16.Append(tabChar13);

            Run run17 = new Run() { RsidRunProperties = "00561389" };
            ...
            run17.Append(tabChar14);

            Run run18 = new Run() { RsidRunProperties = "00561389" };
            ...
            run18.Append(tabChar15);

            Run run19 = new Run() { RsidRunProperties = "00561389" };
            ...
            run19.Append(tabChar16);

            Run run20 = new Run() { RsidRunProperties = "00561389" };
            ...
            //Text text6 = new Text();
            //text6.Text = "=_____________";

            run20.Append(runProperties20);
            run20.Append(tabChar17);
            run20.Append(text6);
            ...
            Paragraph paragraph7 = new Paragraph() { RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            runProperties28.Append(runFonts35);
            runProperties28.Append(fontSize35);
            runProperties28.Append(fontSizeComplexScript35);
            ...
            runProperties29.Append(runFonts36);
            ...
            //text8.Text = "   ______________";

            run29.Append(runProperties29);
            run29.Append(tabChar25);
            run29.Append(text8);
            ...
            Paragraph paragraph8 = new Paragraph() { RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };

            ParagraphProperties paragraphProperties8 = new ParagraphProperties();

            ParagraphBorders paragraphBorders3 = new ParagraphBorders();
            BottomBorder bottomBorder3 = new BottomBorder() { Val = BorderValues.Wave, Color = "auto", Size = (UInt32Value)6U, Space = (UInt32Value)1U };
            ...
            paragraphMarkRunProperties8.Append(runFonts37);
            paragraphMarkRunProperties8.Append(fontSize37);
            paragraphMarkRunProperties8.Append(fontSizeComplexScript37);

            paragraphProperties8.Append(paragraphBorders3);
            paragraphProperties8.Append(spacingBetweenLines8);
            paragraphProperties8.Append(paragraphMarkRunProperties8);

            paragraph8.Append(paragraphProperties8);

            Paragraph paragraph9 = new Paragraph() { RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            paragraphMarkRunProperties9.Append(runFonts38);
            paragraphMarkRunProperties9.Append(fontSize38);
            paragraphMarkRunProperties9.Append(fontSizeComplexScript38);
            paragraphMarkRunProperties9.Append(languages2);
            ...
            Paragraph paragraph10 = new Paragraph() { RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            paragraphMarkRunProperties10.Append(fontSize39);
            paragraphMarkRunProperties10.Append(fontSizeComplexScript39);
            paragraphMarkRunProperties10.Append(languages3);
            ...
            runProperties30.Append(languages4);
            //Text text9 = new Text();
            //text9.Text = "__/__/__";
            ...
            FontSizeComplexScript fontSizeComplexScript42 = new FontSizeComplexScript() { Val = "32" };
            ...
            runProperties33.Append(languages7);
            TabChar tabChar28 = new TabChar();

            run33.Append(runProperties33);
            run33.Append(tabChar28);
            ...
            FontSizeComplexScript fontSizeComplexScript45 = new FontSizeComplexScript() { Val = "32" };
            ...
            runProperties35.Append(languages9);
            TabChar tabChar30 = new TabChar();

            run35.Append(runProperties35);
            run35.Append(tabChar30);
            ...
            FontSizeComplexScript fontSizeComplexScript46 = new FontSizeComplexScript() { Val = "32" };
            ...
            runProperties37.Append(languages11);
            TabChar tabChar32 = new TabChar();

            run37.Append(runProperties37);
            run37.Append(tabChar32);
            ...
            runProperties39.Append(languages12);
            //Text text12 = new Text();
            //text12.Text = ": ___________";
            ...
            Paragraph paragraph11 = new Paragraph() { RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            FontSizeComplexScript fontSizeComplexScript50 = new FontSizeComplexScript() { Val = "32" };
            ...
            Paragraph paragraph12 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            FontSizeComplexScript fontSizeComplexScript51 = new FontSizeComplexScript() { Val = "32" };

            paragraphMarkRunProperties12.Append(runFonts51);
            ...
            FontSizeComplexScript fontSizeComplexScript53 = new FontSizeComplexScript() { Val = "32" };
            ...
            runProperties41.Append(languages14);
            ...
            FontSizeComplexScript fontSizeComplexScript54 = new FontSizeComplexScript() { Val = "32" };
            ...
            //text15.Text = " _____________________________";
            ...
            Paragraph paragraph13 = new Paragraph() { RsidParagraphMarkRevision = "00561389", RsidParagraphAddition = "00561389", RsidParagraphProperties = "00561389", RsidRunAdditionDefault = "00561389" };
            ...
            FontSizeComplexScript fontSizeComplexScript55 = new FontSizeComplexScript() { Val = "32" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00561389", RsidR = "00561389" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "008C0E20" };
            Rsid rsid1 = new Rsid() { Val = "00561389" };
            Rsid rsid2 = new Rsid() { Val = "008C0E20" };
            Rsid rsid3 = new Rsid() { Val = "00BE0798" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<w15:docId w15:val=\"{761D19DE-D399-4275-83D9-881C9CBD78B4}\" xmlns:w15=\"http://schemas.microsoft.com/office/word/2012/wordml\" />");
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts56 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            FontSize fontSize56 = new FontSize() { Val = "22" };
            FontSizeComplexScript fontSizeComplexScript56 = new FontSizeComplexScript() { Val = "22" };
            Languages languages15 = new Languages() { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };

            runPropertiesBaseStyle1.Append(runFonts56);
            runPropertiesBaseStyle1.Append(fontSize56);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript56);
            runPropertiesBaseStyle1.Append(languages15);
        ...
        {
            document.PackageProperties.Creator = "Ruby";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "2";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2018-12-05T09:31:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2018-12-05T09:37:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Ruby";
        }
